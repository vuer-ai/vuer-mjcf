...
class MPLRight(Body):
    ...
    _preamble = """
      ...
      <asset>
        <mesh name="index0" 	file="{assets}/index0_collision.obj"/>
        <mesh name="index1" 	file="{assets}/index1_collision.obj"/>
        <mesh name="index2" 	file="{assets}/index2_collision.obj"/>
        <mesh name="index3" 	file="{assets}/index3_collision.obj"/>
        <mesh name="middle0" 	file="{assets}/middle0_collision.obj"/>
        <mesh name="middle1" 	file="{assets}/middle1_collision.obj"/>
        <mesh name="middle2" 	file="{assets}/middle2_collision.obj"/>
        <mesh name="middle3" 	file="{assets}/middle3_collision.obj"/>
        <mesh name="palm" 		file="{assets}/palm.obj"/>
        <mesh name="pinky0" 	file="{assets}/pinky0_collision.obj"/>
        <mesh name="pinky1" 	file="{assets}/pinky1_collision.obj"/>
        <mesh name="pinky2" 	file="{assets}/pinky2_collision.obj"/>
        <mesh name="pinky3" 	file="{assets}/pinky3_collision.obj"/>
        <mesh name="ring0" 		file="{assets}/ring0_collision.obj"/>
        <mesh name="ring1" 		file="{assets}/ring1_collision.obj"/>
        <mesh name="ring2" 		file="{assets}/ring2_collision.obj"/>
        <mesh name="ring3" 		file="{assets}/ring3_collision.obj"/>
        <mesh name="thumb0" 	file="{assets}/thumb0_collision.obj"/>
        <mesh name="thumb1" 	file="{assets}/thumb1_collision.obj"/>
        <mesh name="thumb2" 	file="{assets}/thumb2_collision.obj"/>
        <mesh name="thumb3" 	file="{assets}/thumb3_collision.obj"/>
        <mesh name="wristx" 	file="{assets}/wristx_collision.obj"/>
        <mesh name="wristy" 	file="{assets}/wristy_collision.obj"/>
        <mesh name="wristz" 	file="{assets}/wristz_collision.obj"/>
            
        <texture type="skybox" builtin="gradient" rgb1=".4 .6 .8" rgb2="0 0 0" width="100" height="100"/>
        <texture name="skin" type="cube" file="{assets}/skin.png"/>
        <texture name="marble2d" type="2d" file="{assets}/marble.png"/>
        <texture name="marblecube" type="cube" file="{assets}/marble.png"/>
                                  ...
                                  <body name="thumb2" pos="0.0335 0 -0.0007426">
                                      ...
                                      <body name="thumb3" pos="0.0335 0 0.0010854">
                                        <inertial pos="0.0188965 0.000375725 0.00065381" quat="0.502274 0.484638 0.475673 0.535333" mass="0.00599792" diaginertia="9.96692e-007 9.64948e-007 5.14416e-007" />
                                          ...
                                          <!-- <site name="thumb_distal" pos="0.0156 -0.006 0.0003" size=".015 .0075 .01" axisangle="0 0 1 0.2"/> -->
                              ...
                              <body name="index1" pos="6.26e-005 -0.018 0">
                                  ...
                                  <body name="index2" pos="0.001086 -0.0435 0.0005">
                                      ...
                                      <body name="index3" pos="-0.000635 -0.0245 0">
                                          ...
                                          <!-- <site name="index_distal" pos="0 -0.0132 -0.0038" size=".0075 .01 .006" group="4"/> -->
