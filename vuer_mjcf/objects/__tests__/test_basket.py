...
def test_basket():
    ...
    obj = Basket(name="test_basket", pos=[0, 0, 1])

    # Wrap in MuJoCo scene
    scene = DefaultStage(obj, model="test_basket_scene")
    ...
    try:
        ...
        try:
            ...
            print(f"✓ Basket model loaded successfully!")
