...
def test_poncho():
    ...
    # Create a Poncho instance
    obj = Poncho(name="test_poncho", pos=[0, 0, 1], rgba="0.8 0.1 0.1 1.0")

    # Wrap in MuJoCo scene
    scene = DefaultStage(obj, model="test_poncho_scene")
    ...
    try:
        ...
        try:
            ...
            print(f"✓ Poncho model loaded successfully!")
