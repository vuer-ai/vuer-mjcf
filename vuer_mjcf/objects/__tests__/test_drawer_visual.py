"""Test file for DrawerVisual object"""
import tempfile
from pathlib import Path


def test_drawer_visual():
    ...
    # Create a KitchenDrawerVisual instance
    obj = KitchenDrawerVisual(name="test_drawer_visual", pos=[0, 0, 1])

    # Wrap in MuJoCo scene
    scene = DefaultStage(obj, model="test_drawer_visual_scene")
    ...
    try:
        ...
        try:
            ...
            print(f"✓ KitchenDrawerVisual model loaded successfully!")
